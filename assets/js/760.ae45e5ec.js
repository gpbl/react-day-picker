...
/* harmony export */ });
/* harmony import */ var _types_965d4afd_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(1025);
/* harmony import */ var dequal__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6701);
/* harmony import */ var _base_3665f77c_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(45891);
/* harmony import */ var outvariant__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(12284);
...
var Protocol = /** @class */ (function () {
    function Protocol(type, handleMessage, protocol) {
        ...
        this._disposeMessageListener = this.protocol.channelListen(function (msg) { return (0,_types_965d4afd_mjs__WEBPACK_IMPORTED_MODULE_2__._)(_this, void 0, void 0, function () {
            var message, result, response, err_1, response;
            return (0,_types_965d4afd_mjs__WEBPACK_IMPORTED_MODULE_2__.a)(this, function (_a) {
                switch (_a.label) {
                    case 0:
...
var IFrameProtocol = /** @class */ (function () {
    ...
    IFrameProtocol.prototype.dispatch = function (message) {
        ...
        this.frameWindow.postMessage((0,_types_965d4afd_mjs__WEBPACK_IMPORTED_MODULE_2__.h)({ $id: this.channelId, codesandbox: true }, message), this.origin);
    };
...
modules) {
    ...
    var totalDependencies = (0,_types_965d4afd_mjs__WEBPACK_IMPORTED_MODULE_2__.i)((0,_types_965d4afd_mjs__WEBPACK_IMPORTED_MODULE_2__.i)([], Object.keys(dependencies), true), Object.keys(devDependencies), true);
...
var _a;
var BUNDLER_URL = "https://" + ((_a = "2.0.29") === null || _a === void 0 ? void 0 : _a.replace(/\./g, "-")) + "-sandpack.codesandbox.io/";
var SandpackRuntime = /** @class */ (function (_super) {
    (0,_types_965d4afd_mjs__WEBPACK_IMPORTED_MODULE_2__.g)(SandpackRuntime, _super);
    function SandpackRuntime(selector, sandboxSetup, options) {
        ...
        if (typeof selector === "string") {
            ...
            (0,_types_965d4afd_mjs__WEBPACK_IMPORTED_MODULE_2__.n)(element, "The element '" + selector + "' was not found");
        ...
        if (!_this.iframe.getAttribute("sandbox")) {
            ...
            _this.iframe.setAttribute("allow", "accelerometer; camera; encrypted-media; geolocation; gyroscope; hid; microphone; midi;");
        }
        ...
        _this.unsubscribeGlobalListener = _this.iframeProtocol.globalListen(function (mes) {
            ...
            if (_this.options.fileResolver) {
                _this.fileResolverProtocol = new Protocol("fs", function (data) { return (0,_types_965d4afd_mjs__WEBPACK_IMPORTED_MODULE_2__._)(_this, void 0, void 0, function () {
                    return (0,_types_965d4afd_mjs__WEBPACK_IMPORTED_MODULE_2__.a)(this, function (_a) {
            ...
            switch (mes.type) {
                ...
                case "action": {
                    if (mes.action === "show-error") {
                        _this.errors = (0,_types_965d4afd_mjs__WEBPACK_IMPORTED_MODULE_2__.i)((0,_types_965d4afd_mjs__WEBPACK_IMPORTED_MODULE_2__.i)([], _this.errors, true), [(0,_types_965d4afd_mjs__WEBPACK_IMPORTED_MODULE_2__.e)(mes)], false);
                    }
                    break;
                }
                case "state": {
    ...
    SandpackRuntime.prototype.updateSandbox = function (sandboxSetup, isInitializationCompile) {
        ...
        this.sandboxSetup = (0,_types_965d4afd_mjs__WEBPACK_IMPORTED_MODULE_2__.h)((0,_types_965d4afd_mjs__WEBPACK_IMPORTED_MODULE_2__.h)({}, this.sandboxSetup), sandboxSetup);
        var files = this.getFiles();
        var modules = Object.keys(files).reduce(function (prev, next) {
            var _a;
            return ((0,_types_965d4afd_mjs__WEBPACK_IMPORTED_MODULE_2__.h)((0,_types_965d4afd_mjs__WEBPACK_IMPORTED_MODULE_2__.h)({}, prev), (_a = {}, _a[next] = {
                code: files[next].code,
                path: next
            }, _a)));
        }, {});
        var packageJSON = JSON.parse((0,_types_965d4afd_mjs__WEBPACK_IMPORTED_MODULE_2__.b)(this.sandboxSetup.dependencies, this.sandboxSetup.devDependencies, this.sandboxSetup.entry));
        try {
            packageJSON = JSON.parse(files["/package.json"].code);
        }
        catch (e) {
            console.error((0,_types_965d4afd_mjs__WEBPACK_IMPORTED_MODULE_2__.c)("could not parse package.json file: " + e.message));
        }
        ...
        this.dispatch({
            ...
            logLevel: (_d = this.options.logLevel) !== null && _d !== void 0 ? _d : _types_965d4afd_mjs__WEBPACK_IMPORTED_MODULE_2__.S.Info,
    ...
    SandpackRuntime.prototype.getCodeSandboxURL = function () {
        ...
        var paramFiles = Object.keys(files).reduce(function (prev, next) {
            var _a;
            return ((0,_types_965d4afd_mjs__WEBPACK_IMPORTED_MODULE_2__.h)((0,_types_965d4afd_mjs__WEBPACK_IMPORTED_MODULE_2__.h)({}, prev), (_a = {}, _a[next.replace("/", "")] = {
                content: files[next].code,
                isBinary: false
            }, _a)));
        }, {});
    ...
    SandpackRuntime.prototype.getFiles = function () {
        ...
        if (sandboxSetup.files["/package.json"] === undefined) {
            return (0,_types_965d4afd_mjs__WEBPACK_IMPORTED_MODULE_2__.d)(sandboxSetup.files, sandboxSetup.dependencies, sandboxSetup.devDependencies, sandboxSetup.entry);
        }
    ...
    SandpackRuntime.prototype.initializeElement = function () {
        ...
        (0,_types_965d4afd_mjs__WEBPACK_IMPORTED_MODULE_2__.n)(this.element.parentNode, "The given iframe does not have a parent.");
...
;
//# sourceMappingURL=760.ae45e5ec.js.map