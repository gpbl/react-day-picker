...
<Description>
Represents the value of the [FocusContext](/api/main/variables/FocusContext.md).
</Description>
...
<SignatureMemberIdentifier>**FocusContextValue**: `Object`</SignatureMemberIdentifier>
