...
We prepared a [Upgrading guide](https://daypicker.dev/upgrading) for help upgrading your app to v9. We welcome feedback about the upgrade process, to ensure it's smooth for everyone.
...
- Added new [`onDayMouseDown`](https://daypicker.dev/docs/api.html#ondaymousedown) and [`onDayMouseUp`](https://daypicker.dev/docs/api.html#ondaymouseup) props ([#445](https://github.com/gpbl/react-day-picker/issues/445) by [eldritchideen](https://github.com/eldritchideen))
...
- **DayPickerInput**: added [`clickUnselectsDay`](https://daypicker.dev/docs/api-input.html#clickunselectsday) prop to unselect and clear the input when clicking on a previously selected day ([#399](https://github.com/gpbl/react-day-picker/issues/399))
...
See [example](https://daypicker.dev/examples/input.html), [docs](https://daypicker.dev/docs/input.html) and [API reference](https://daypicker.dev/docs/api-input.html).

**New features**

- New [`todayButton`](https://daypicker.dev/docs/api-daypicker.html#todaybutton) prop ([#329](https://github.com/gpbl/react-day-picker/issues/329)).
...
- New [`showWeekDays`](https://daypicker.dev/docs/api-daypicker.html#showweekdays) and [`onWeekClick`](https://daypicker.dev/docs/api-daypicker.html#onweekclick) props ([#304](https://github.com/gpbl/react-day-picker/issues/304)).
...
- New `daysOfWeek` [modifiers type](https://daypicker.dev/docs/modifiers.html) to match days of the weeks ([#330](https://github.com/gpbl/react-day-picker/issues/330)).
...
- Added: a new [`modifiersStyles`](https://daypicker.dev/docs/api-daypicker.html#modifiersstyles) prop to add inline style to the days matching the given modifiers (see [`example`](https://daypicker.dev/docs/api-daypicker.html#modifiersstyles)).
...
- Pass React Components to [`navBarElement`](https://daypicker.dev/docs/api-daypicker.html#navBarElement), [`captionElement`](https://daypicker.dev/docs/api-daypicker.html#captionElement), [`weekdayElement`](https://daypicker.dev/docs/api-daypicker.html#weekdayElement) ([#280](https://github.com/gpbl/react-day-picker/pull/280) by [cwmoo740](https://github.com/cwmoo740))
...
- New [`classNames`](https://daypicker.dev/docs/api-daypicker.html#classnames) prop ([#264](https://github.com/gpbl/react-day-picker/issues/264)).

  Use this prop to change the CSS class names or add support for CSS modules ([#73](https://github.com/gpbl/react-day-picker/issues/73), see [this example](https://daypicker.dev/docs/css-modules.html)).

- New [`month`](https://daypicker.dev/docs/api-daypicker.html#month) prop ([#263](https://github.com/gpbl/react-day-picker/issues/263)).

  This differs from the `initialMonth` props as it causes the calendar to re-render when its value changes.

- Added: `aria-label` attributes to the navigation bar with the new [`labels`](https://daypicker.dev/docs/api-daypicker.html#labels) prop ([#258](https://github.com/gpbl/react-day-picker/issues/258)).
...
- **New modifiers value types** ([#254](https://github.com/gpbl/react-day-picker/issues/254))
  ...
  Read more in the [modifiers documentation](https://daypicker.dev/docs/modifiers.html).
...
- **Breaking change** Use [`containerProps`](https://daypicker.dev/docs/api-daypicker.html#containerprops) to pass props to the container `div` element. Before, any prop was passed to the container element degrading performance ([#255](https://github.com/gpbl/react-day-picker/issues/255)):
...
- **Breaking change** Updating `initialMonth` will not show anymore a different month after the first mount ([#169](https://github.com/gpbl/react-day-picker/issues/169))
  ...
  If you need the calendar to display a different month, use the [`month`](https://daypicker.dev/docs/api-daypicker.html#month) prop.
...
- Added [`weekdayComponent`](https://daypicker.dev/docs/api-daypicker.html#weekdaycomponent-component) prop ([#172](https://github.com/gpbl/react-day-picker/pull/172) by [stanislav-ermakov-roi](https://github.com/stanislav-ermakov-roi)). Use this prop to use a custom component for rendering the weekday cells in the header.
- Added [`navbarComponent`](https://daypicker.dev/docs/api-daypicker.html#navbarcomponent-component) prop ([#173](https://github.com/gpbl/react-day-picker/pull/173) by [stanislav-ermakov-roi](https://github.com/stanislav-ermakov-roi)). Use this prop to use a custom component for rendering the navigation bar.
...
- New `formatDay` function in [LocaleUtils](https://daypicker.dev/docs/utils-locale.html).

If you are using your [custom LocaleUtils](https://daypicker.dev/docs/localization.html#advanced) to localize the calendar, you need to implement this function as well, which is required to format the newly added [aria-label attribute](https://github.com/gpbl/react-day-picker/pull/132) (see the [documentation](https://daypicker.dev/docs/localization.html#advanced) for an example). If you are localizing [using moment](https://daypicker.dev/docs/localization.html#moment), this change shouldn't affect you.

**New props**

- New [`disabledDays`](https://daypicker.dev/docs/api-daypicker.html#disabledays-prop) and [`selectedDays`](https://daypicker.dev/docs/api-daypicker.html#disabledays-prop) props. They receive a function `(day) => Bool` as value to easily define which day should have the `selected` or `disabled` modifiers. See [#34](https://github.com/gpbl/react-day-picker/issues/34) for more details.
...
- Added [`reverseMonths`](https://daypicker.dev/docs/api-daypicker.html#reversemonths-prop) prop to render the most recent month first. ([#147](https://github.com/gpbl/react-day-picker/pull/141) by @sonrtomas
- Added [`onDayKeyDown`](https://daypicker.dev/docs/api-daypicker.html#ondaykeydown-prop), [`onDayTouchStart`](https://daypicker.dev/docs/api-daypicker.html#ondaytouchstart-prop), [`onDayTouchEnd`](https://daypicker.dev/docs/api-daypicker.html#ondaytouchend-prop) props.
...
First major release. Please see [the updated website](https://daypicker.dev) for more info.

- [#27] Removed the dependency from moment.js. Events and props work **only** with native `Date` object. To localize the Day Picker with moment.js (or another library), follow [this page](https://daypicker.dev/#tips)
