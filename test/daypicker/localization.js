...
describe('DayPicker’s localization', () => {
  it('should use the months prop to localize the month names', () => {
    const wrapper = mount(<DayPicker initialMonth={new Date(2015, 0)} months={['Gennaio', 'Febbraio', 'Marzo', 'Aprile', 'Maggio', 'Giugno', 'Luglio', 'Agosto', 'Settembre', 'Ottobre', 'Novembre', 'Dicembre']} />);
  ...
  it('should use the firstDayOfWeek prop to set the first day of the week', () => {
    const wrapper = mount(<DayPicker initialMonth={new Date(2015, 0)} firstDayOfWeek={1} />);
  ...
  it('should use the weekdaysShort prop to localize the weekday names', () => {
    const wrapper = mount(<DayPicker initialMonth={new Date(2015, 0)} weekdaysShort={['Do', 'Lu', 'Ma', 'Me', 'Gi', 'Ve', 'Sa']} />);
  ...
  it('should use the weekdaysLong prop to localize the weekday names', () => {
    const wrapper = mount(<DayPicker initialMonth={new Date(2015, 0)} weekdaysLong={['Domenica', 'Lunedì', 'Martedì', 'Mercoledì', 'Giovedì', 'Venerdì', 'Sabato']} />);
    expect(wrapper
        .find('.DayPicker-Weekday > abbr')
        .first()).toHaveProp('title', 'Domenica');
  });
