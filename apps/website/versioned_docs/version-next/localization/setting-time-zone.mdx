...
When working with time zones, use the `TZDate` object exported by `@daypicker/react` instead of the native `Date` object. `TZDate` ensures your user interface always reads and writes dates in the time zone you specify.
...
<BrowserWindow
  ...
  sourceUrl="https://github.com/gpbl/react-day-picker/blob/release/v10-next/examples/TimeZone.tsx"
>
  <Examples.TimeZone />
</BrowserWindow>
...
<BrowserWindow
  bodyStyle={{ justifyContent: "start" }}
  sourceUrl="https://github.com/gpbl/react-day-picker/blob/release/v10-next/examples/TimeZoneNoonSafeSimple.tsx"
