...
DayPicker can localize month names, weekday labels, and other text using the locales provided by [date-fns](https://date-fns.org/docs/I18n). All locales are exported from `@daypicker/react/locale`.
...
<BrowserWindow sourceUrl="https://github.com/gpbl/react-day-picker/blob/release/v10-next/examples/Spanish.tsx">
  <Examples.Spanish />
</BrowserWindow>
...
| Prop Name  | Type                                          | Description                                     |
| ---------- | --------------------------------------------- | ----------------------------------------------- |
| `numerals` | [`Numerals`](../api/react/type-aliases/Numerals.md) | Numbering system for labels and formatted text. |
...
<BrowserWindow sourceUrl="https://github.com/gpbl/react-day-picker/blob/release/v10-next/examples/Numerals.tsx">
  <Examples.Numerals />
</BrowserWindow>
...
<BrowserWindow sourceUrl="https://github.com/gpbl/react-day-picker/blob/release/v10-next/examples/Rtl.tsx">
  <Examples.Rtl />
</BrowserWindow>
