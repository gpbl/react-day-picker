...
<BrowserWindow sourceUrl="https://github.com/gpbl/react-day-picker/blob/release/v10-next/examples/Dropdown.tsx">
  <Examples.Dropdown />
</BrowserWindow>
...
| `undefined`       | Uses the legacy layout. With dropdown captions, tab order may not match visual order.     |

```tsx
<DayPicker navLayout="around" />
```

<BrowserWindow sourceUrl="https://github.com/gpbl/react-day-picker/blob/release/v10-next/examples/NavLayout.tsx">
  <Examples.NavLayout />
</BrowserWindow>
...
<BrowserWindow sourceUrl="https://github.com/gpbl/react-day-picker/blob/release/v10-next/examples/NavLayoutAfter.tsx">
...
Leaving `navLayout` undefined preserves the legacy layout for existing integrations. When using `"dropdown"` as caption layout, set `navLayout` to `"after"` or `"around"` to ensure the component [remains accessible](https://www.w3.org/TR/WCAG22/#focus-order).

This default is expected to change once [shadcn-ui/ui#10441](https://github.com/shadcn-ui/ui/pull/10441) lands in shadcn/ui.
...
<BrowserWindow sourceUrl="https://github.com/gpbl/react-day-picker/blob/release/v10-next/examples/DisableNavigation.tsx">
...
<BrowserWindow sourceUrl="https://github.com/gpbl/react-day-picker/blob/release/v10-next/examples/HideNavigation.tsx">
