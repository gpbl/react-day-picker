...
<BrowserWindow sourceUrl="https://github.com/gpbl/react-day-picker/blob/release/v10-next/examples/DefaultMonth.tsx">
...
| `onMonthChange` | [`MonthChangeEventHandler`](../api/react/type-aliases/MonthChangeEventHandler.md) | Callback when the month changes.     |
...
<BrowserWindow sourceUrl="https://github.com/gpbl/react-day-picker/blob/release/v10-next/examples/Controlled.tsx">
  <Examples.Controlled />
</BrowserWindow>
...
<BrowserWindow sourceUrl="https://github.com/gpbl/react-day-picker/blob/release/v10-next/examples/StartEndMonths.tsx">
...
<BrowserWindow sourceUrl="https://github.com/gpbl/react-day-picker/blob/release/v10-next/examples/Animate.tsx">
  <Examples.Animate />
</BrowserWindow>
