...
<BrowserWindow sourceUrl="https://github.com/gpbl/react-day-picker/blob/release/v10-next/examples/Weeknumber.tsx">
  <Examples.Weeknumber />
</BrowserWindow>
...
<BrowserWindow sourceUrl="https://github.com/gpbl/react-day-picker/blob/release/v10-next/examples/Footer.tsx">
  <Examples.Footer />
</BrowserWindow>
...
| Prop Name    | Type                                              | Description                                                 |
| ------------ | ------------------------------------------------- | ----------------------------------------------------------- |
| `components` | [`CustomComponents`](../api/react/index.md#components)  | Change the internal components used to render the calendar. |
| `classNames` | [`ClassNames`](../api/react/type-aliases/ClassNames.md) | Use custom class names instead of the default ones.         |
