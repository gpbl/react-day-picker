...
In DayPicker, a **custom modifier** is added to a day when the day matches a specific condition, called a [`Matcher`](../api/react/type-aliases/Matcher.md).

Modifiers are set using the `modifiers` prop. When a date matches a modifier, the modifier is passed to the `onSelect` event and other [DayEventHandler](../api/react/type-aliases/DayEventHandler.md) events (`onDayClick`, etc.) to inspect the days the user has interacted with.
...
- DayPicker comes with some [pre-built modifiers](../api/react/type-aliases/Modifiers.md), such as `disabled`, `selected`, `hidden`, `today`, `range_start`, etc., designed to cover the most common use cases.
...
Use the `disabled` modifier to disable one or more days. Pass a [`Matcher`](../api/react/type-aliases/Matcher.md) or an array of matchers to specify the disabled days:
...
<BrowserWindow sourceUrl="https://github.com/gpbl/react-day-picker/blob/release/v10-next/examples/ModifiersDisabled.tsx">
...
<BrowserWindow sourceUrl="https://github.com/gpbl/react-day-picker/blob/release/v10-next/examples/ModifiersHidden.tsx">
...
<BrowserWindow sourceUrl="https://github.com/gpbl/react-day-picker/blob/release/v10-next/examples/ModifiersToday.tsx">
...
<BrowserWindow sourceUrl="https://github.com/gpbl/react-day-picker/blob/release/v10-next/examples/ModifiersClassnames.tsx">
