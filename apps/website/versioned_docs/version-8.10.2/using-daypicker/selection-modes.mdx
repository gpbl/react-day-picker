...
The following DayPicker requires the <kbd>Shift</kbd> key to select a range of dates. See [examples/RangeShiftKey.tsx](https://github.com/gpbl/react-day-picker/blob/main/apps/website/examples/RangeShiftKey.tsx) for the full source code.
