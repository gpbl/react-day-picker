...
Implement a custom `Day` component to select ranges while pressing the <kbd>Shift</kbd> key. See [examples/RangeShiftKey.tsx](https://github.com/gpbl/react-day-picker/blob/main/apps/website/examples/RangeShiftKey.tsx) for the full source code.
