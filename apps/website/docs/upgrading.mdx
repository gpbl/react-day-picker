...
If you are upgrading from v7, this guide is still valid. First, read the [migration guide from v7 to v8](../versioned_docs/version-8.10.2/upgrading.mdx), then follow the steps below.
