...
If your app uses a React framework or bundler that supports CSS imports, import the DayPicker stylesheet once from your app's entry point:
...
<BrowserWindow sourceUrl="https://github.com/gpbl/react-day-picker/blob/main/examples/TailwindCSS.tsx">
