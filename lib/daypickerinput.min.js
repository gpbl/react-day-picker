!(function(e, t) {
  'object' == typeof exports && 'object' == typeof module
    ? (module.exports = t(require('react'), require('moment')))
    : 'function' == typeof define && define.amd
        ? define(['react', 'moment'], t)
        : 'object' == typeof exports
            ? (exports.DayPicker = t(require('react'), require('moment')))
            : (e.DayPicker = t(e.React, e.moment));
})(this, function(e, t) {
  return (function(e) {
    function t(n) {
    ...
    function(e, t, a) {
      ...
      function s(e, t) {
        return n(e).setHours(0, 0, 0, 0) < n(t).setHours(0, 0, 0, 0);
      }
      function i(e, t) {
        return n(e).setHours(0, 0, 0, 0) > n(t).setHours(0, 0, 0, 0);
      }
      function l(e) {
        var t = new Date();
        return t.setHours(0, 0, 0, 0), s(e, t);
      }
      function u(e) {
      ...
      function f(e, t, a) {
        var o = n(e);
        return o.setHours(0, 0, 0, 0), (i(o, t) && s(o, a)) ||
          (i(o, a) && s(o, t));
      }
      function d(e) {
      ...
      function c(e, t) {
        var a = t.from, n = t.to;
        return (a && r(e, a)) || (n && r(e, n)) || (a && n && f(e, a, n));
      }
      function h(e) {
        var t = n(e);
        return t.setHours(0, 0, 0), t.setDate(
          t.getDate() + 4 - (t.getDay() || 7)
        ), Math.ceil(((t - new Date(t.getFullYear(), 0, 1)) / 864e5 + 1) / 7);
      }
      Object.defineProperty(t, '__esModule', {
        value: !0,
      }), (t.clone = n), (t.addMonths = o), (t.isSameDay = r), (t.isDayBefore = s), (t.isDayAfter = i), (t.isPastDay = l), (t.isFutureDay = u), (t.isDayBetween = f), (t.addDayToRange = d), (t.isDayInRange = c), (t.getWeekNumber = h), (t.default = {
        addDayToRange: d,
        addMonths: o,
        clone: n,
        getWeekNumber: h,
    ...
    function(e, t, a) {
      ...
      function i(e) {
        var t = e.firstDayOfWeek,
          ...
          r = void 0 === o ? {} : o;
        return isNaN(t)
          ? r.getFirstDayOfWeek ? r.getFirstDayOfWeek(n) : 0
          : t;
      }
      function l(e) {
      ...
      function f(e) {
        ...
        o.forEach(function(e) {
          s.length > 0 &&
            ...
            (i.push(
              s
            ), (s = [])), s.push(e), o.indexOf(e) === o.length - 1 && i.push(s);
        });
        for (var u = i[0], f = 7 - u.length; f > 0; f -= 1) {
          var d = (0, h.clone)(u[0]);
          d.setDate(u[0].getDate() - 1), u.unshift(d);
        }
        for (var c = i[i.length - 1], y = c.length; y < 7; y += 1) {
          var v = (0, h.clone)(c[c.length - 1]);
          v.setDate(c[c.length - 1].getDate() + 1), c.push(v);
        }
        if (a && i.length < 6)
          for (var m = void 0, k = i.length; k < 6; k += 1) {
            m = i[i.length - 1];
            for (var g = m[m.length - 1], D = [], b = 0; b < 7; b += 1) {
              var M = (0, h.clone)(g);
              M.setDate(g.getDate() + b + 1), D.push(M);
            }
            i.push(D);
          }
        return i;
      ...
      (t.cancelEvent = n), (t.getFirstDayOfMonth = o), (t.getDaysInMonth = r), (t.getModifiersFromProps = s), (t.getFirstDayOfWeekFromProps = i), (t.isRangeOfDates = l), (t.getMonthsDiff = u), (t.getWeekArray = f), (t.startOfMonth = d);
      var h = a(2), p = a(5);
    },
    function(e, t, a) {
      'use strict';
    ...
    function(e, t, a) {
      ...
      Object.defineProperty(t, '__esModule', {
        value: !0,
      }), (t.dayMatchesModifier = n), (t.getModifiersForDay = o);
      var r = a(2), s = a(3);
      t.default = { dayMatchesModifier: n, getModifiersForDay: o };
    },
    function(e, t, a) {
      'use strict';
      function n(e) {
    ...
    function(e, t, a) {
        ...
        q = (function(e) {
          ...
          return u(t, e), d(t, [
            ...
            },
            {
              ...
              value: function() {
                return C.addMonths(this.state.currentMonth, -1);
              },
            },
            {
              key: 'allowPreviousMonth',
              value: function() {
                var e = C.addMonths(this.state.currentMonth, -1);
              ...
              value: function(e) {
                if (this.allowNextMonth()) {
                  var t = this.props.pagedNavigation
                    ? this.props.numberOfMonths
                    : 1,
                    a = C.addMonths(this.state.currentMonth, t);
                  this.showMonth(a, e);
                }
              },
            },
            ...
            },
            {
              ...
              value: function() {
                if (this.allowYearChange()) {
                  var e = C.addMonths(this.state.currentMonth, 12);
                  this.showMonth(e);
                }
              },
            },
              ...
              value: function(e, t, a) {
                switch ((a.persist(), a.keyCode)) {
                  ...
                  case j.default.DOWN:
                    ...
                    break;
                  case j.default.ENTER:
                  case j.default.SPACE:
            ...
            },
            {
              ...
              value: function(e, t) {
                var a = N.getModifiersFromProps(this.props),
                  n = W.getModifiersForDay(e, a);
                C.isSameDay(e, new Date()) &&
            ...
            },
            {
              ...
              value: function() {
                for (
                  ...
                  var n = C.addMonths(this.state.currentMonth, a);
                  e.push(
                    h.default.createElement(
                      g.default,
                      {
      ...
      (q.VERSION = '5.5.0'), (q.propTypes = {
        initialMonth: B.default.instanceOf(Date),
        month: B.default.instanceOf(Date),
        numberOfMonths: B.default.number,
        fromMonth: B.default.instanceOf(Date),
        toMonth: B.default.instanceOf(Date),
        canChangeMonth: B.default.bool,
        reverseMonths: B.default.bool,
        pagedNavigation: B.default.bool,
        todayButton: B.default.string,
        showWeekNumbers: B.default.bool,
        selectedDays: B.default.oneOfType([
          F.ModifierPropType,
          B.default.arrayOf(F.ModifierPropType),
        ]),
        disabledDays: B.default.oneOfType([
          F.ModifierPropType,
          B.default.arrayOf(F.ModifierPropType),
        ]),
        modifiers: B.default.object,
        modifiersStyles: B.default.object,
        dir: B.default.string,
        firstDayOfWeek: B.default.oneOf([0, 1, 2, 3, 4, 5, 6]),
        labels: B.default.shape({
          nextMonth: B.default.string.isRequired,
          previousMonth: B.default.string.isRequired,
        }).isRequired,
        locale: B.default.string,
        localeUtils: B.default.localeUtils,
        months: B.default.arrayOf(B.default.string),
        weekdaysLong: B.default.arrayOf(B.default.string),
        weekdaysShort: B.default.arrayOf(B.default.string),
        enableOutsideDays: B.default.bool,
        fixedWeeks: B.default.bool,
        classNames: B.default.shape({
          body: B.default.string,
          container: B.default.string,
          day: B.default.string.isRequired,
          disabled: B.default.string.isRequired,
          footer: B.default.string,
          interactionDisabled: B.default.string,
          month: B.default.string,
          navBar: B.default.string,
          outside: B.default.string.isRequired,
          selected: B.default.string.isRequired,
          today: B.default.string.isRequired,
          todayButton: B.default.string,
          week: B.default.string,
        }),
        className: B.default.string,
        containerProps: B.default.object,
        tabIndex: B.default.number,
        renderDay: B.default.func,
        weekdayElement: B.default.oneOfType([
          B.default.element,
          B.default.func,
          B.default.instanceOf(c.Component),
        ]),
        ...
        onDayClick: B.default.func,
        onDayKeyDown: B.default.func,
        onDayMouseEnter: B.default.func,
        onDayMouseLeave: B.default.func,
        onDayTouchStart: B.default.func,
        onDayTouchEnd: B.default.func,
        onDayFocus: B.default.func,
        onMonthChange: B.default.func,
        onCaptionClick: B.default.func,
        onWeekClick: B.default.func,
      }), (q.defaultProps = {
      ...
      var U = function() {
        ...
        }), (this.dayPicker = null), (this.handleTodayButtonClick = function(
          t
        ) {
    ...
    function(e, t, a) {
        ...
        return a &&
          ...
          : i.default.createElement(
              'div',
              {
                ...
                role: 'gridcell',
                'aria-label': m,
                'aria-disabled': k.toString(),
                'aria-selected': g.toString(),
                onClick: o(c, n, l),
                onKeyDown: o(h, n, l),
                onMouseEnter: o(f, n, l),
                onMouseLeave: o(d, n, l),
                onTouchEnd: o(y, n, l),
                onTouchStart: o(p, n, l),
                onFocus: o(v, n, l),
              },
              D
            );
      ...
      var s = a(1), i = n(s), l = a(4), u = n(l), f = a(0), d = n(f);
      (r.propTypes = {
    ...
    function(e, t, a) {
      ...
      function o(e) {
        var t = e.classNames,
          ...
          M = s.default.isValidElement(r)
            ? s.default.cloneElement(r, b)
            : s.default.createElement(r, b),
          w = (0, d.getWeekArray)(a, y, o);
        return s.default.createElement(
          'div',
          ...
          s.default.createElement(
            ...
            w.map(function(e) {
              var n = void 0;
              return g &&
                (n = (0, c.getWeekNumber)(e[0])), s.default.createElement(
                'div',
                { key: e[0].getTime(), className: t.week, role: 'row' },
                g &&
                  s.default.createElement(
                    'div',
                    {
                      className: t.weekNumber,
                      tabIndex: 0,
                      role: 'gridcell',
                      onClick: function(t) {
                        return D(n, e, t);
          ...
          k && s.default.createElement('div', { className: t.footer }, k)
        );
      }
      Object.defineProperty(t, '__esModule', { value: !0 }), (t.default = o);
      var r = a(1),
      ...
      o.propTypes = {
        ...
        footer: l.default.node,
        showWeekNumbers: l.default.bool,
        onWeekClick: l.default.func,
      ...
      function o(e) {
        for (
          ...
          var c = (d + a) % 7,
            ...
            p = s.default.isValidElement(u)
              ? s.default.cloneElement(u, h)
              : s.default.createElement(u, h);
          f.push(p);
        }
        return s.default.createElement(
          'div',
          ...
          s.default.createElement(
            ...
            n && s.default.createElement('div', { className: t.weekday }),
            f
          )
        );
      }
    ...
    function(e, t, a) {
      ...
      function i(e) {
        var t = void 0;
        if (e.value) {
          var a = (0, y.default)(e.value, e.format, !0);
          a.isValid() && (t = a.toDate());
        } else
          t =
            e.dayPickerProps.initialMonth ||
            e.dayPickerProps.month ||
            new Date();
        return { showOverlay: !1, value: e.value, month: t };
      }
      Object.defineProperty(t, '__esModule', {
        value: !0,
      ...
      var l =
        ...
        M = (function(e) {
          function t(e) {
            ...
            return (a.input = null), (a.daypicker = null), (a.clickedInside = !1), (a.clickTimeout = null), (a.hideTimeout = null), (a.hideAfterDayClick = function() {
              a.props.hideOnDayClick &&
                (a.hideTimeout = setTimeout(function() {
                  return a.hideDayPicker();
                }, b));
            }), (a.handleContainerMouseDown = function() {
              (a.clickedInside = !0), (a.clickTimeout = setTimeout(function() {
                a.clickedInside = !1;
              }, 0));
            }), (a.handleClick = function(e) {
              a.showDayPicker(), a.props.onClick &&
                (e.persist(), a.props.onClick(e));
            }), (a.handleFocus = function(e) {
              a.showDayPicker(), a.props.onFocus &&
                (e.persist(), a.props.onFocus(e));
            }), (a.handleBlur = function(e) {
              a.setState({ showOverlay: a.clickedInside }), a.clickedInside &&
                a.input.focus(), a.props.onBlur &&
                (e.persist(), a.props.onBlur(e));
              ...
              var t = e.target.value,
                ...
                i = n.onChange,
                u = (0, y.default)(t, o, !0);
              if ((i && (e.persist(), i(e)), !u.isValid()))
                return a.setState({ value: t }), void (s && s(void 0, {}));
              var f = u.toDate();
              if ((a.setState({ month: f, value: t }), s)) {
                var d = l(
                  { disabled: r.disabledDays, selected: r.selectedDays },
                  r.modifiers
                ),
                  c = (0, k.getModifiersForDay)(f, d).reduce(function(e, t) {
                    var a = l({}, e);
                    return (a[t] = !0), a;
                  }, {});
                a.props.onDayChange(u, c);
              }
            }), (a.handleOnKeyUp = function(e) {
              a.setState({ showOverlay: e.keyCode !== D.default.ESC }), a.props
                .onKeyUp && (e.persist(), a.props.onKeyUp(e));
            }), (a.handleDayClick = function(e, t, n) {
              if (
                (a.props.dayPickerProps.onDayClick &&
                  a.props.dayPickerProps.onDayClick(e, t, n), !t.disabled)
              ) {
                if (t.selected)
                  return a.setState({ value: '' }, a.hideAfterDayClick), void (a
                    .props.onDayChange && a.props.onDayChange(void 0, t));
                var o = (0, y.default)(e);
                a.setState(
                  { value: o.format(a.props.format), month: e },
                  a.hideAfterDayClick
                ), a.props.onDayChange && a.props.onDayChange(o, t);
              }
            }), (a.state = i(e)), a;
          }
          return s(t, e), u(t, [
            {
              ...
              value: function() {
                clearTimeout(this.clickTimeout), clearTimeout(this.hideTimeout);
              },
            },
            {
              key: 'showDayPicker',
            ...
            },
            {
              key: 'render',
              value: function() {
                var e = this, t = l({}, this.props);
                return delete t.component, delete t.dayPickerProps, delete t.format, delete t.hideOnDayClick, delete t.onDayChange, delete t.classNames, d.default.createElement(
                  'div',
                  {
      ...
      (M.propTypes = {
        ...
        format: h.default.string.isRequired,
        dayPickerProps: h.default.object,
        hideOnDayClick: h.default.bool,
        component: h.default.any,
        classNames: h.default.shape({
          container: h.default.string,
          overlayWrapper: h.default.string,
          overlay: h.default.string.isRequired,
        }),
        onDayChange: h.default.func,
