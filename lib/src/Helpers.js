...
function getModifiersForDay(d) {
  ...
  return Object.keys(modifiersObj).reduce(function(modifiers, modifier) {
    ...
    if (value instanceof Date && (0, _DateUtils.isSameDay)(d, value)) {
      ...
      modifiers.push(modifier);
    } else if (value.after && (0, _DateUtils.isDayAfter)(d, value.after)) {
      // modifier's value has an after date
      modifiers.push(modifier);
    } else if (value.before && (0, _DateUtils.isDayBefore)(d, value.before)) {
      // modifier's value has an after date
      modifiers.push(modifier);
...
function getWeekArray(d) {
  var firstDayOfWeek = arguments.length > 1 && arguments[1] !== undefined
    ? arguments[1]
