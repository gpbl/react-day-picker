!(function(e, t) {
  ...
  return (function(e) {
    ...
    function(e, t, a) {
      ...
      Object.defineProperty(t, '__esModule', {
        value: !0,
      }), (t.clone = n), (t.addMonths = o), (t.isSameDay = r), (t.isDayBefore = s), (t.isDayAfter = i), (t.isPastDay = u), (t.isFutureDay = l), (t.isDayBetween = f), (t.addDayToRange = d), (t.isDayInRange = c), (t.getWeekNumber = h), (t.default = {
        addDayToRange: d,
        addMonths: o,
        clone: n,
        getWeekNumber: h,
    ...
    function(e, t, a) {
      ...
      function f(e) {
        ...
        for (var c = i[i.length - 1], p = c.length; p < 7; p += 1) {
        ...
        if (a && i.length < 6)
          for (var m = void 0, g = i.length; g < 6; g += 1) {
            m = i[i.length - 1];
            for (var k = m[m.length - 1], M = [], D = 0; D < 7; D += 1) {
              var b = (0, h.clone)(k);
              b.setDate(k.getDate() + D + 1), M.push(b);
            }
            i.push(M);
          }
        return i;
      ...
      (t.cancelEvent = n), (t.getFirstDayOfMonth = o), (t.getDaysInMonth = r), (t.getModifiersFromProps = s), (t.getFirstDayOfWeekFromProps = i), (t.isRangeOfDates = u), (t.getMonthsDiff = l), (t.getWeekArray = f), (t.startOfMonth = d);
      var h = a(2), y = a(5);
    },
    function(e, t, a) {
      'use strict';
    ...
    function(e, t, a) {
        ...
        q = (function(e) {
          ...
          return l(t, e), d(t, [
            ...
            },
            {
              ...
              value: function() {
                var e = void 0;
                e = this.props.classNames === _.default
            ...
            },
            {
              ...
              value: function() {
                return E.addMonths(this.state.currentMonth, -1);
              },
            },
            {
              key: 'allowPreviousMonth',
              value: function() {
                var e = E.addMonths(this.state.currentMonth, -1);
            ...
            },
            {
              ...
              value: function(e) {
                ...
                return !(!t.canChangeMonth ||
                  (a && O.getMonthsDiff(a, e) < 0) ||
                  (n && O.getMonthsDiff(n, e) > 0));
              },
            },
            {
              key: 'allowYearChange',
              ...
              value: function(e) {
                if (this.allowNextMonth()) {
                  var t = this.props.pagedNavigation
                    ? this.props.numberOfMonths
                    : 1,
                    a = E.addMonths(this.state.currentMonth, t);
                  this.showMonth(a, e);
                }
              },
            },
            ...
            },
            {
              ...
              value: function() {
                if (this.allowYearChange()) {
                  var e = E.addMonths(this.state.currentMonth, 12);
                  this.showMonth(e);
                }
              },
            },
            ...
            },
            {
              ...
              value: function(e, t, a) {
                switch ((a.persist(), a.keyCode)) {
                  case F.default.LEFT:
                    O.cancelEvent(a), this.focusPreviousDay(a.target);
                    break;
                  case F.default.RIGHT:
                    O.cancelEvent(a), this.focusNextDay(a.target);
                    break;
                  case F.default.UP:
                    O.cancelEvent(a), this.focusPreviousWeek(a.target);
                    break;
                  case F.default.DOWN:
                    O.cancelEvent(a), this.focusNextWeek(a.target);
                    break;
                  case F.default.ENTER:
                  case F.default.SPACE:
                    O.cancelEvent(a), this.props.onDayClick &&
            ...
            },
            {
              ...
              value: function(e, t) {
                var a = O.getModifiersFromProps(this.props),
                  n = W.getModifiersForDay(e, a);
                E.isSameDay(e, new Date()) &&
            ...
            },
            {
              ...
              value: function() {
                for (
                  var e = [],
                    t = O.getFirstDayOfWeekFromProps(this.props),
                    a = 0;
                  a < this.props.numberOfMonths;
                  a += 1
                ) {
                  var n = E.addMonths(this.state.currentMonth, a);
                  e.push(
                    h.default.createElement(
                      k.default,
                      {
      ...
      (q.VERSION = '5.5.1'), (q.propTypes = {
        ...
        selectedDays: B.default.oneOfType([
          j.ModifierPropType,
          B.default.arrayOf(j.ModifierPropType),
        ]),
        ...
        captionElement: h.default.createElement(p.default, {
          classNames: _.default,
        }),
      });
      var U = function() {
        ...
        (this.getStateFromProps = function(e) {
          var t = O.startOfMonth(e.month || e.initialMonth), a = t;
          if (e.pagedNavigation && e.numberOfMonths > 1 && e.fromMonth) {
            var n = O.getMonthsDiff(e.fromMonth, a);
            a = E.addMonths(
              e.fromMonth,
        ...
        return a &&
          ...
          : i.default.createElement(
              'div',
              {
                ...
                'aria-selected': k.toString(),
                onClick: o(c, n, u),
                onKeyDown: o(h, n, u),
                onMouseEnter: o(f, n, u),
                onMouseLeave: o(d, n, u),
                onTouchEnd: o(p, n, u),
                onTouchStart: o(y, n, u),
                onFocus: o(v, n, u),
              },
              M
            );
    ...
    function(e, t, a) {
      ...
      function o(e) {
        var t = e.classNames,
          ...
          b = s.default.isValidElement(r)
            ? s.default.cloneElement(r, D)
            : s.default.createElement(r, D),
          w = (0, d.getWeekArray)(a, p, o);
        return s.default.createElement(
          'div',
          ...
          g && s.default.createElement('div', { className: t.footer }, g)
        );
      }
      Object.defineProperty(t, '__esModule', { value: !0 }), (t.default = o);
      var r = a(1),
      ...
      o.propTypes = {
        ...
        footer: u.default.node,
        showWeekNumbers: u.default.bool,
        onWeekClick: u.default.func,
      ...
      function o(e) {
        for (
          ...
          var c = (d + a) % 7,
            ...
            y = s.default.isValidElement(l)
              ? s.default.cloneElement(l, h)
              : s.default.createElement(l, h);
          f.push(y);
        }
        return s.default.createElement(
          'div',
    ...
    ,
    function(e, t, a) {
      var n = a(11), o = a(2), r = a(5), s = a(6), i = a(8), u = a(7), l = a(0);
      (e.exports = n.default || n), (e.exports.DateUtils =
        o.default || o), (e.exports.LocaleUtils =
        r.default || r), (e.exports.ModifiersUtils =
        s.default || s), (e.exports.WeekdayPropTypes =
        i.WeekdayPropTypes), (e.exports.NavbarPropTypes =
        u.NavbarPropTypes), (e.exports.PropTypes = l);
    },
  ]);
});
