  ...
  _createClass(DayPickerInput, [{
    ...
    value: function hideDayPicker() {
      ...
      this.setState({ showOverlay: false }, function () {
        if (_this2.props.onDayPickerHide) _this2.props.onDayPickerHide();
      });
    }
  }, {
    ...
    value: function handleMonthChange(month) {
      ...
      this.setState({ month: month }, function () {
        if (_this7.props.dayPickerProps && _this7.props.dayPickerProps.onMonthChange) {
          _this7.props.dayPickerProps.onMonthChange(month);
        }
      });
    }
  }, {
    ...
    value: function renderOverlay() {
      ...
      if (dayPickerProps.todayButton) {
        ...
        onTodayButtonClick = function onTodayButtonClick() {
          return _this9.updateState(new Date(), formatDate(new Date(), format, dayPickerProps.locale), _this9.hideAfterDayClick);
        };
      }
