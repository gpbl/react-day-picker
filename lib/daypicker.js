...
var DayPickerInput = function (_React$Component) {
  ...
  _createClass(DayPickerInput, null, [{
    key: 'getDerivedStateFromProps',
    value: function getDerivedStateFromProps(newProps, previousState) {
  ...
  _createClass(DayPickerInput, [{
    ...
    key: 'isInputButtonClick',
    value: function isInputButtonClick(e) {
      if (this.props.inputProps.clearButtonRef.current && this.props.inputProps.clearButtonRef.current.contains(e.target)) {
        this.hideDayPicker();
        e.preventDefault();
        return true;
      }
      if (this.props.inputProps.dropdownButtonRef.current && this.props.inputProps.dropdownButtonRef.current.contains(e.target)) {
        e.preventDefault();
        return true;
      }
      return false;
