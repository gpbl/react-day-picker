...
var _Weekday = __webpack_require__(18);
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.getStateFromProps = function (props) {
    ...
    if (props.pagedNavigation && props.numberOfMonths > 1 && props.fromMonth) {
      ...
      var _diffInMonths = Helpers.getMonthsDiff(props.toMonth, currentMonth);
      if (_diffInMonths <= 0) {
...
exports.LocaleUtils = exports.ModifiersUtils = exports.DateUtils = exports.Input = exports.default = undefined;

var _DayPicker = __webpack_require__(9);

var _DayPicker2 = _interopRequireDefault(_DayPicker);

var _DayPickerInput = __webpack_require__(19);

var _DayPickerInput2 = _interopRequireDefault(_DayPickerInput);

var _DateUtils2 = __webpack_require__(3);

var _DateUtils3 = _interopRequireDefault(_DateUtils2);

var _ModifiersUtils2 = __webpack_require__(8);

var _ModifiersUtils3 = _interopRequireDefault(_ModifiersUtils2);

var _LocaleUtils2 = __webpack_require__(5);
...
exports.Input = _DayPickerInput2.default;
exports.DateUtils = _DateUtils3.default;
exports.ModifiersUtils = _ModifiersUtils3.default;
...
var _MomentLocaleUtils = __webpack_require__(20);
  ...
  _createClass(DayPickerInput, [{
    ...
    value: function updateState(day, value, callback) {
      ...
      this.setState({ month: day, value: value }, function () {
        ...
        onDayChange((0, _moment2.default)(day), modifiers);
      });
    }
    ...
    value: function handleDayClick(day, modifiers, e) {
      ...
      if (modifiers.selected && clickUnselectsDay) {
        ...
        } else if ((0, _moment2.default)(selectedDays).isValid()) {
          selectedDays = null;
        }
      ...
      var m = (0, _moment2.default)(day).locale(dayPickerProps.locale || 'en');
      var value = m.format(typeof format === 'string' ? format : format[0]);
    ...
    value: function renderOverlay() {
      ...
      if (dayPickerProps.todayButton) {
        ...
        onTodayButtonClick = function onTodayButtonClick() {
          return _this6.updateState(new Date(), (0, _moment2.default)().locale(dayPickerProps.locale || 'en').format(_this6.props.format), _this6.hideAfterDayClick);
        };
      }
    ...
    value: function render() {
      ...
      var _props5 = this.props,
          ...
          overlayComponent = _props5.overlayComponent,
          dayPickerProps = _props5.dayPickerProps,
          format = _props5.format,
          clickUnselectsDay = _props5.clickUnselectsDay,
          hideOnDayClick = _props5.hideOnDayClick,
          onDayChange = _props5.onDayChange,
          classNames = _props5.classNames,
          inputProps = _objectWithoutProperties(_props5, ['component', 'overlayComponent', 'dayPickerProps', 'format', 'clickUnselectsDay', 'hideOnDayClick', 'onDayChange', 'classNames']);
...
DayPickerInput.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  format: _propTypes2.default.oneOfType([_propTypes2.default.arrayOf(_propTypes2.default.string), _propTypes2.default.string]),
