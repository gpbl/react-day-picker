...
var Caption = function (_Component) {
  ...
  _createClass(Caption, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: classNames.caption, role: 'presentation' },
        _react2.default.createElement(
          'div',
...
var Month = function (_Component) {
  ...
  function Month() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Month.__proto__ || Object.getPrototypeOf(Month)).call.apply(_ref, [this].concat(args))), _this), _this.renderDay = function (day) {
      ...
      if (isToday && !Object.prototype.hasOwnProperty.call(propModifiers, _this.props.classNames.today)) {
  ...
  _createClass(Month, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: classNames.month, role: 'application' },
        caption,
        ...
        _react2.default.createElement(
          'div',
          { className: classNames.body, role: 'presentation' },
...
var Weekdays = function (_Component) {
  ...
  _createClass(Weekdays, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: classNames.weekdays, role: 'presentation', 'aria-hidden': true },
        _react2.default.createElement(
          'div',
          { className: classNames.weekdaysRow, role: 'presentation', 'aria-hidden': true },
  ...
  _createClass(Day, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          ariaCurrent = _props.ariaCurrent,
...
Day.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  ariaCurrent: _propTypes2.default.bool,
