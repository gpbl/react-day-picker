...
var DayPickerInput = function (_React$Component) {
  ...
  _createClass(DayPickerInput, [{
    ...
    value: function updateState(day, value, callback) {
      ...
      this.setState({ month: day, value: value, inputValue: value }, function () {
        if (callback) {
          callback();
        }
        if (!onDayChange) {
    ...
    value: function handleInputBlur(e) {
      ...
      var _props2 = this.props,
          ...
          parseOnInputBlur = _props2.parseOnInputBlur,
          value = _props2.value;
      ...
      if (parseOnInputBlur) {
        ...
        var newDay = parseDate(newValue, format, dayPickerProps.locale) || '';
        if (isNaN(newDay) || newDay.valueOf() === value.valueOf()) {
          this.setState(function (_state, prevProps) {
            return {
              inputValue: prevProps.formatDate(prevProps.value, prevProps.format, prevProps.dayPickerProps.locale)
            };
          });
          return;
        }
    ...
    value: function handleInputChange(e) {
      var _props3 = this.props,
          ...
          parseOnInputBlur = _props3.parseOnInputBlur;
    ...
    value: function handleDayClick(day, modifiers, e) {
      ...
      var _props4 = this.props,
          clickUnselectsDay = _props4.clickUnselectsDay,
      ...
      if (modifiers.selected && clickUnselectsDay) {
        ...
        this.setState({ value: '', inputValue: '', selectedDays: selectedDays }, this.hideAfterDayClick);
        if (onDayChange) {
      ...
      this.setState({ value: value, inputValue: value, month: day }, function () {
        if (onDayChange) {
          onDayChange(day, modifiers);
        }
...
DayPickerInput.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  parseOnInputBlur: _propTypes2.default.bool,
