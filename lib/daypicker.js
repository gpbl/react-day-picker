...
var _DayPickerInput = __webpack_require__(17);
  ...
  function Month() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Month.__proto__ || Object.getPrototypeOf(Month)).call.apply(_ref, [this].concat(args))), _this), _this.renderDay = function (day) {
      ...
      var _this$props = _this.props,
          ...
          fixedWeeks = _this$props.fixedWeeks,
          toMonth = _this$props.toMonth,
          fromMonth = _this$props.fromMonth;

      var empty = isOutside && !showOutsideDays && !fixedWeeks || toMonth && isOutside && DateUtils.isDayAfter(day, toMonth) || fromMonth && isOutside && DateUtils.isDayBefore(day, fromMonth);
