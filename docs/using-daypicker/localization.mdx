---
sort: 5
description: Understand how to localize and translate DayPicker.
---
...
| Prop Name    | Type                                                    | Description                                |
| ------------ | ------------------------------------------------------- | ------------------------------------------ |
| `labels`     | [`Labels`](/api/latest/type-aliases/Labels.mdx)         | Map the ARIA labels used within DayPicker. |
| `formatters` | [`Formatters`](/api/latest/type-aliases/Formatters.mdx) | Map the function used as date formatters.  |
