...
sort: 30
toc: true
description: "Upgrade to the latest version of DayPicker."
---
...
<Callout title="Semantic Versioning">
  DayPicker follows the [Semantic Versioning](https://semver.org/) and tries to
  keep the API as stable as possible. Sometimes breaking changes are necessary
  to improve the library, especially in its internal component.
</Callout>
