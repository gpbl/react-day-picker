...
DayPicker follows the [Semantic Versioning](https://semver.org/) and tries to keep the API as stable as possible. However, sometimes breaking changes are necessary to improve the library, especially in its internal component and style.

This guide will help you to upgrade from previous versions of DayPicker.
...
- Please note that [~useInput hook~](/api/latest/functions/useInput) has been deprecated since v8.10.0.
