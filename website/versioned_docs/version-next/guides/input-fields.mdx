...
See the [full source code](https://github.com/gpbl/react-day-picker/blob/release/v10-next/examples/Input.tsx) and [unit tests](https://github.com/gpbl/react-day-picker/blob/release/v10-next/examples/Input.test.tsx) for this example.

<BrowserWindow sourceUrl="https://github.com/gpbl/react-day-picker/blob/release/v10-next/examples/Input.tsx">
  <Examples.Input />
</BrowserWindow>
...
<BrowserWindow sourceUrl="https://github.com/gpbl/react-day-picker/blob/release/v10-next/examples/Dialog.tsx">
  <Examples.Dialog />
</BrowserWindow>
