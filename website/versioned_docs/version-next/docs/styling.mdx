...
If you are not using a bundler, you can copy the CSS file to your project. See the [style.css](https://github.com/gpbl/react-day-picker/blob/release/v10-next/packages/react-day-picker/src/style.css) file in the DayPicker repository for the source.
...
- Read the [`style.css`](https://github.com/gpbl/react-day-picker/blob/release/v10-next/packages/react-day-picker/src/style.css) file from the source and get familiar with the [UI elements](../docs/anatomy.mdx).
