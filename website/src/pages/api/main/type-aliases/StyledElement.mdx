...
<SignatureMemberIdentifier>**StyledElement**\<`T`\>: `Object`</SignatureMemberIdentifier>
...
node\_modules/.pnpm/react-day-picker@8.10.0\_date-fns@3.3.1\_react@18.2.0/node\_modules/react-day-picker/src/types/Styles.ts:4
