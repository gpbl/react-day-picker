...
const rdpBuild = require(`!!raw-loader!react-day-picker`);
const rdpStyles = require(`!!raw-loader!react-day-picker/style.css`);
...
/**
 * Render the Sandpack for docusaurus, by simulating a small React app with the
 * given source code.
 */
