...
describe('when a day is clicked', () => {
  ...
  test('should appear as selected', () => {
    expect(getDayButton(days[0])).toHaveAttribute(
      'aria-pressed',
      'true'
    );
  });
  ...
  describe('when a second day is clicked', () => {
    ...
    test('the second day should appear as selected', () => {
      expect(getDayButton(days[1])).toHaveAttribute(
        'aria-pressed',
        'true'
      );
    });
...
describe('when the first 5 days are clicked', () => {
  ...
  test.each(days)(
    'the %s day should appear as selected',
    (day) => {
  ...
  describe('when a sixth day is clicked', () => {
    ...
    test('it should not appear as selected', () => {
      expect(getDayButton(day6)).not.toHaveAttribute(
        'aria-pressed'
      );
    });
  });
