...
To hide the navigation completely, set the `hideNavigation` prop to `true`. This is useful when setting the [caption layout](./appearance.mdx#caption-layouts) to `"dropdown"`.
