...
Use the customization props to tailor the appearance of the calendar.
...
To enable a navigation dropdown, assign `captionLayout="dropdown"`. Use the `startMonth` and `endMonth` properties to set the start and end dates for the calendar navigation.
