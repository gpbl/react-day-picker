...
To enable a navigation dropdown, assign `captionLayout="dropdown"`. Use `startMonth` and `endMonth` properties to set the [the start/end dates](./navigation.mdx#start-and-end-dates).
