...
The current [shadcn/ui](https://ui.shadcn.com) does not show the latest version. For a proper integration, please refer to [shadcn-datetime-picker](https://github.com/Maliksidk19/shadcn-datetime-picker) or [date-picker.luca-felix.com](https://date-picker.luca-felix.com).
