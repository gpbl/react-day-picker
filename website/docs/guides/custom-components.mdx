...
Custom components allow you to extend DayPicker beyond just using [formatters](./translation.mdx#translation-props). While formatters modify the content within the calendar, custom components enable you to alter the structure of the HTML elements.
