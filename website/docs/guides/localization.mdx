...
- set [formatCaption](../reference/props.mdx#formatcaption) to format the year in caption;
- set [formatWeekNumber](../reference/props.mdx#formatweeknumber) to format the week numbers.
