...
> DayPicker can be easily localized using
> [date-fns](https://date-fns.org/docs/I18n).

## Changing locale

To change the locale, pass to the [locale prop](./reference/props.mdx#locale) a date-fns [Locale
...
To add right-to-left text direction, set the [dir](./reference/props.mdx#dir) prop to `rtl`.
...
[Formatter props](./reference/props.mdx#formatting) can be used also change the
