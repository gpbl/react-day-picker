...
The `Day` component is used to render the day in the calendar. To specify your own `Day` component:
...
The `Caption` component is used to render the caption (with month/year) in the calendar. To specify your own `Caption` component:
...
The `Navigation` component is used to render the navigation buttons. To specify your own `Navigation` component:
...
The `WeekNumber` component is used to render the week number when [`showWeekNumber`](./props#showweeknumber) is set. To specify your own `WeekNumber` component:
