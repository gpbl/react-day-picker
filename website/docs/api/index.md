...
- [DateSelection](types/dateselection.md)
...
- [RangeSelectionHandler](types/rangeselectionhandler.md)
- [SelectEventHandler](types/selecteventhandler.md)
- [SelectionType](types/selectiontype.md)
...
- [useRangeSelection](functions/userangeselection.md)
