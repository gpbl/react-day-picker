...
As opposed to [month](daypickerrange.md#month), use this prop to let DayPicker control the current
month.
...
• `Optional` **defaultSelected**: *undefined* \| [*DateRange*](../types/daterange.md)
...
Change the class name for the day matching the [modifiers](daypickerrange.md#modifiers).
...
Change the inline style for the day matching the [modifiers](daypickerrange.md#modifiers).
...
• `Optional` **onSelect**: *undefined* \| [*SelectRangeEventHandler*](../types/selectrangeeventhandler.md)
...
Paginate the month navigation displaying the [numberOfMonths](daypickerrange.md#numberofmonths) at time.
...
Render the months in reversed order (when [numberOfMonths](daypickerrange.md#numberofmonths) is greater
