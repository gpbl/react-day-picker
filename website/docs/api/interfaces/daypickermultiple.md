...
As opposed to [month](daypickermultiple.md#month), use this prop to let DayPicker control the current
month.
...
As opposed to [defaultMonth](daypickermultiple.md#defaultmonth), use this prop with [onMonthChange](daypickermultiple.md#onmonthchange) to
