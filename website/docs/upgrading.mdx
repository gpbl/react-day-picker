...
The CSS classes have been updated and simplified. If you are using custom styles, you will need to update them. See the [styles guide](./guides/styles.mdx) for more information.

### 3. Remove use of `fromDate`, `toDate`
...
### 4. Update tests and translations
...
```diff title="./test.js"
- screen.getByRole('button', 'Go to the Previous Month');
...
### 5. Update formatters to return a string
...
### 5. Update your Custom Components

In case you are using the `components` prop, you may need to update your code. See [custom component](./guides/custom-components.mdx) guide.
