...
The CSS classes have been updated and simplified. If you are using custom styles, you will need to update them. See the [styling docs](./docs/styling.mdx) for more information.
...
### 6. Update your Custom Components
