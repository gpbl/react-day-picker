...
:::note
DayPicker v10 does not change behavior for non-deprecated APIs. If your app is not using deprecated v9 APIs, it should continue to work after upgrading without code changes.
:::
...
| `onDayKeyUp`, `onDayKeyPress`, `onDayPointerEnter`, `onDayPointerLeave`, `onDayTouchCancel`, `onDayTouchEnd`, `onDayTouchMove`, `onDayTouchStart` | Custom [`DayButton`](./api/functions/DayButton) component |
