...
The customizable components are defined by [`CustomComponents`](../api/type-aliases/CustomComponents). Pass any of these to the `components` prop.
...
| ---------------------------------------------------------------- | -------------------------------------------------------------------------------------------- |
| [`MonthCaption`](../api/functions/MonthCaption.md)               | The caption for each month.                                                                  |
...
| [`WeekdaysRow`](../api/functions/WeekdaysRow.md)                 | The row with the weekdays names.                                                             |
...
| [`WeekRow`](../api/functions/WeekRow.md)                         | Render the row with the week.                                                                |
| [`WeekNumberRowHeader`](../api/functions/WeekNumberRowHeader.md) | Render the week number.                                                                      |
