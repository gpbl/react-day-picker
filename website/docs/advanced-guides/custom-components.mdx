...
function CustomDayDate(props: DayDateProps) {
  return (
...
export function MyDatePicker() {
  return <DayPicker mode="single" components={{ DayDate: CustomDayDate }} />;
}
```
...
| [useModifiers](../api/functions/useModifiers.md) | Access the modifiers used by the calendar.                                 |
