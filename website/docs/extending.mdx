...
DayPicker can be extended by implementing custom components. Use the [`components`](./props#components) prop to change DayPicker internal components and add new custom props.

It is possible to use the following custom components:
...
## Extending the Caption Component
...
## Extending the WeekNumber Component
