...
DayPicker offers various props to toggle features or customize the navigation.
...
Use [formatting props](./props#formatting) to format the content of the day cell, the month’s caption, the weekday name or the week’s number.
