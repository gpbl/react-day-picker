...
Use formatting props to format the content of the day cell, the month’s caption,the weekday name or the weeknumber:
...
For more advanced customization, it is possible to use [custom components]('./custom-components.mdx').
