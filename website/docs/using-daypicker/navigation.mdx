...
To hide the navigation completely, set the `hideNavigation` prop to `true`. Useful when setting the [caption layout](./customization.mdx#caption-layout) to `"dropdown"`.
