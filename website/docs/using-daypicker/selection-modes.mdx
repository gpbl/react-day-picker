...
| `disabled` | [`Matcher`](/api/type-aliases/Matcher.mdx) \| `Matcher[]` | Disabled days that cannot be selected.     |
...
| `onSelect` | [`SelectSingleEventHandler`](/api/type-aliases/SelectSingleEventHandler.mdx) | Event callback when a date is selected. |
...
| `onSelect` | [`SelectMultipleEventHandler`](/api/type-aliases/SelectMultipleEventHandler.mdx) | Event callback when a date is selected. |
...
| Prop Name  | Type                                                                       | Description                             |
| ---------- | -------------------------------------------------------------------------- | --------------------------------------- |
| `selected` | [`DateRange`](/api/type-aliases/DateRange.mdx)                             | The selected range.                     |
| `onSelect` | [`SelectRangeEventHandler`](/api/type-aliases/SelectRangeEventHandler.mdx) | Event callback when a date is selected. |
| `min`      | `number`                                                                   | The minimum dates that can be selected. |
| `max`      | `number`                                                                   | The maximum dates that can be selected. |
...
To disable specific days, use the `disabled` prop. The prop accepts a [`Matcher`](/api/type-aliases/Matcher.mdx) or an array of matchers that can be used to make some days not selectable.
