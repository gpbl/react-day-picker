...
| `--rdp-weeknumber-border-radius`    | The border radius of the week number.                               |
| `--rdp-weeknumber-border`           | The border of the week number.                                      |
| `--rdp-weeknumber-font`             | The font of the week number cells.                                  |
| `--rdp-weeknumber-height`           | The height of the week number cells.                                |
| `--rdp-weeknumber-opacity`          | The opacity of the week number.                                     |
| `--rdp-weeknumber-width`            | The width of the week number cells.                                 |
