...
1. Create a CSS module using the class names listed in [StyledElements](/api/types/styledelement)
...
Hint: you can copy [this CSS
file](https://github.com/gpbl/react-day-picker/blob/master/packages/react-day-picker/style.css),
remove the `rdp-` prefix from the selectors and save in your project as
`.module.css` file.
