...
In DayPicker, Modifiers are used to customize the appearance of the days in the calendar. For example, you can use modifiers to:

- disable days
- mark days as selected
- mark days as highlighted
- mark days as outside the month
- mark days as today
- mark days as after a given date
