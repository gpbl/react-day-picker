...
This patch release keeps `@daypicker/hebrew` aligned with `@daypicker/react` v10.0.1 and adds `@types/react` as an optional peer dependency for strict package managers.
